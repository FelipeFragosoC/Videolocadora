...
{
    public class GeneroCinematograficoController
    {

        public GeneroCinematografico BuscarPorId(int id)
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(strConexao))
            {
                ...
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    ...
                    string query = $"SELECT * FROM genero_cinematografico WHERE id = {id}";
                    ...
                    GeneroCinematografico retorno = new GeneroCinematografico();
